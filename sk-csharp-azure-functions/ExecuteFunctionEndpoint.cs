...
public class ExecuteFunctionEndpoint
{
    ...
    [OpenApiParameter(name: "skillName", Description = "Name of the skill e.g., 'MtcSkill'", Required = true)]
    [OpenApiParameter(name: "functionName", Description = "Name of the function e.g., 'AgendaBuilder'", Required = true)]
